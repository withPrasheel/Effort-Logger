...
public class passwordEncryptor {
    public String encryptString(String input) throws NoSuchAlgorithmException {     //Method to encrypt a password string given a specified hashing algorithm.
        ...
        byte[] messageDigest = md.digest(input.getBytes());                     //Convert password input string to a byte array to consistently represent the data as a byte for individual character encoding.

        BigInteger bigInt = new BigInteger(1, messageDigest);       //Convert the password byte array to a positive BigInteger to handle 
